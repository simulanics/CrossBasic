...
> 📜 **License:** This project is licensed under the [CrossBasic Source License 1.1 (CBSL-1.1)](https://www.crossbasic.com/license). You may use CrossBasic to build your own projects, including commercially. You may not sell, fork, repackage, or monetize CrossBasic itself without permission. Contact [mcombatti@simulanics.com](mailto:mcombatti@simulanics.com) for commercial licensing.
