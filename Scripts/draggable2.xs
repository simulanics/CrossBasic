...
Function CornerHitTest(px As Integer, py As Integer) As Integer
  ...
  ' Top-left
  If PointInRect(px, py, tlx - half, tly - half, hs, hs) Then 
  Return 0
  End If
  ' Top-right
  If PointInRect(px, py, trx - half, tryy - half, hs, hs) Then 
  Return 1
  End If
  ' Bottom-left
  If PointInRect(px, py, blx - half, bly - half, hs, hs) Then 
  Return 2
  End If
  ' Bottom-right
  If PointInRect(px, py, brx - half, bry - half, hs, hs) Then 
  Return 3
  End If
...
Sub MouseDown(x As Integer, y As Integer)
  ...
  print("In: MouseDown at (" + str(x) + "," + str(y) + ")")
...
print("In: MouseMove at (" + str(x) + "," + str(y) + ")")
  If isDragging Then
    rectX = x - dragOffsetX
    rectY = y - dragOffsetY
