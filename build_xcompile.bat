...
windres ./XCompile-SRC/xcompile.rc -O coff -o ./XCompile-SRC/xcompile.res
if %ERRORLEVEL% NEQ 0 (
...
g++ -s -static -m64 -o xcompile.exe ./XCompile-SRC/xcompile.cpp ./XCompile-SRC/xcompile.res -static-libgcc -static-libstdc++ -O3 -march=native -mtune=native 2> error.log
